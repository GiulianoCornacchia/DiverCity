...
def parse_arguments():
    ...
    # Optional Arguments
    parser.add_argument('-a', '--attribute', type=str, default="travel_time", 
                        help="Path attribute for the shortest path. Default is 'travel_time'.")
...
if __name__ == '__main__':
    ...
    radius_city_m = max_radius_km * 1000  # Buffer for the city's maximum radius in meters
    ...
    with ProcessPoolExecutor(max_workers=N_jobs) as executor:
        futures = {
            executor.submit(
                ...
                G_ig, r, list_p, k, routing_elements,
                penalized_paths_dict, attribute, k_is_route_count, max_it
            ): r for r in routing_elements.keys()
        }
        ...
        for future in as_completed(futures):
            ...
            try:
                ...
                print(f"Error while processing radius {r}: {e}")
    ...
    with ProcessPoolExecutor(max_workers=N_jobs) as executor:
        futures = {
            executor.submit(
                ...
                routing_elements, r, k, penalized_paths_dict,
                n_samples_circle, list_p, list_eps, edge_lengths, results_dict
            ): r for r in routing_elements.keys()
        }
